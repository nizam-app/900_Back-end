...
// Admin only routes
router.post('/', authMiddleware, requireRole('ADMIN'), upload.single('image'), createCategory);
router.patch('/:id', authMiddleware, requireRole('ADMIN'), upload.single('image'), updateCategory);
