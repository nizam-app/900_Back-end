...
console.log(
  "Response: { success, message, tempToken, phone, name, employeeId }\n"
);
...
console.log(
  "  - Verify & Continue button → POST /api/employee/register/verify-otp\n"
);

console.log("Screen 3 (Set Password):");
console.log("  - Password input → password (min 6 characters)");
console.log(
  "  - Create Account button → POST /api/employee/register/complete\n"
);
